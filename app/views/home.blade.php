        ...
        <div class="header-container clearfix">
            ...
            @if(Auth::check())
                <nav id="buttons-logged-in">
                    <a href="{{ URL::action('subscription-sign-out') }}" id="logout" class="logoutbutton">Log Out</a>
    ...
    <div class="container-two">
        ...
        <div class="boxtwo">
            <div class="textbox">
                ...
                <h2>Healthy Eating. <b>Reinvented.</b></h2>

                <p>Order expertly prepared meals that will help you achieve optimum results.</p>


                <div class="download" style="margin-left: 95px;">
                    <a href="{{ URL::action('subscription-join') }}" id="order" class="downloadbutton">Sign Up</a>
                </div>
...
<div class="col-lg-offset-1 col-lg-10">
    <ul class="il insta"></ul>
    <a href="#" class="il-load-more" title="Load more images from Instagram">Load more</a>
