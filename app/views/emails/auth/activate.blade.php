...
<div style="width: 100%;display:block;position: relative;margin: 0;">
    ...
    <div id="top" style="padding: 20px;color: #fff;width: 100%;position: relative;display: block;background-color: #66b83d;">
        ...
        Please activate your subscription using the following link.<br><br>
    </div>
    ...
    <div id="footer" style="padding: 20px;color: #000;width: 100%;position: relative;display: block;background-color: #f7f7f7;">


        <p>We will need to communicate with you from time to time, so it's important we have an up-to-date email address for you on file.</p>
